  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo base_url(); ?>" class="d-block">Achmad Dandi</a>
        </div>
      </div>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Jadwal Praktek Dokter</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-12">
            ...
            <div class="table-responsive">
              ...
              <div class="col-12 mb-3 text-center">
                <a href="home/makepdf" class="btn btn-success"><i class="fa fa-print"></i> Cetak PDF</a>
              </div>
          </div>
        </div>
      </div><!-- /.container-fluid -->
